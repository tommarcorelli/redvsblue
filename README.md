...
- **51 scénarios attaque/défense** couvrant 6 grandes familles techniques :
  ...
  trop permissif, PID namespace hôte partagé et NetworkPolicy absente),
...
js/
  scenarios.js         Les 51 scénarios (vfs, règles d'exploit, correctifs)
