...
- **41 scénarios attaque/défense** couvrant 6 grandes familles techniques :
  ...
  applications web (dont IDOR et mass assignment côté API), et Active
  Directory / Windows (AS-REP Roasting, délégation Kerberos, DCSync, GPO).
...
js/
  scenarios.js         Les 41 scénarios (vfs, règles d'exploit, correctifs)
