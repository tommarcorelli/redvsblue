...
const SKILL_FAMILIES = [
  ...
  { name:'Web & API', icon:'🕸️', color:'var(--red)', ids:['git-directory-exposed','jwt-alg-none-forgery','log4shell-jndi-rce','python-pickle-deserialization','ssti-jinja2-flask','idor-invoice-api','mass-assignment-signup'] },
  { name:'Cloud & IaC', icon:'☁️', color:'var(--gold)', ids:['aws-imds-ssrf','s3-bucket-public','terraform-state-exposed','jenkins-script-console-open','iam-role-overpermissive','secret-in-public-repo','oauth-token-overscope','github-actions-secret-leak'] },
  { name:'Conteneurs', icon:'📦', color:'var(--purple)', ids:['docker-socket-writable','k8s-privileged-hostpath','docker-registry-unauthenticated'] },
  { name:'Active Directory / Windows', icon:'🪟', color:'#7cb3ff', ids:['windows-unquoted-path','ad-asrep-roasting','ad-unconstrained-delegation','ad-dcsync-abuse','ad-gpo-writable'] }
];
