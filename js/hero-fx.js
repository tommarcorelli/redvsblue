...
const ROADMAP = [
  ...
  { version:'v0.6', tag:'système', tagColor:'var(--gold)', done:true,
    ...
    desc:"Les 31 scénarios en nœuds SVG cliquables regroupés par famille technique autour de target-lab, façon Packet Tracer." },
  ...
  { version:'v1.0', tag:'attaque', tagColor:'var(--red)',
    title:'Scénarios chaînés',
    desc:"Attaques multi-étapes (ex. SSRF → accès interne → pivot SUID) à difficulté croissante." },
  { version:'v1.1', tag:'système', tagColor:'var(--gold)',
    title:'Personnalisation',
    desc:"Thème clair façon rapport d'audit, sélecteur de palette, mode contraste élevé." },
  { version:'v2.0', tag:'grosse feature', tagColor:'var(--green)',
    title:'Génération procédurale & éditeur',
    desc:"Scénarios générés automatiquement, et éditeur permettant à un professeur de créer son propre CTF." }
];
