...
const ROADMAP = [
  ...
  { version:'v4.6', tag:'polish', tagColor:'var(--purple)', done:true,
    title:'Recherche & filtres dans l\'onglet Dossiers',
    desc:"Un champ de recherche libre (titre, catégorie, référence réelle) et des menus par famille technique et par statut, avec compteur de résultats et état vide dédié — pour retrouver en un instant un scénario donné parmi tous les autres." },
  { version:'v4.7', tag:'polish', tagColor:'var(--blue)', done:true,
    title:'Autocomplétion Tab dans le terminal',
    desc:"Tab complète commandes et chemins de fichiers/dossiers comme un vrai shell : préfixe commun sur la première pression, liste des candidats sur la seconde — Maj+Tab reste volontairement libre pour continuer à sortir du champ au clavier." },
  { version:'v4.8', tag:'polish', tagColor:'var(--green)', done:true,
    title:'Glossaire pédagogique transverse',
    desc:"47 termes (SUID, JWT, Kerberoasting, IAM, SSRF...) consultables et filtrables à tout moment depuis l'onglet Apprendre, indépendamment de tout scénario précis — pour comprendre le vocabulaire avant, pendant ou après avoir joué." },
  { version:'v4.9', tag:'système', tagColor:'var(--gold)', done:true,
    title:'Accessibilité clavier & ARIA',
    desc:"Piège de focus et fermeture à l'Échap génériques pour toutes les modales, cartes de leçon utilisables au clavier, onglet actif annoncé aux lecteurs d'écran, terminal en région live — sans modifier la logique propre des quatre fonctions qui créent des modales." },
  { version:'v5.0', tag:'grosse feature', tagColor:'var(--green)', done:true,
    title:'Mode Examen chronométré',
    desc:"Trois formats prédéfinis (5, 8 ou 12 systèmes) à traiter entièrement — attaque puis défense — avant l'expiration d'un temps global, façon certification blanche, avec historique local des sessions passées et deux nouveaux succès." },
  { version:'v5.1', tag:'attaque', tagColor:'var(--red)', done:true,
    title:'Pack « Active Directory », 5ᵉ vague — ADCS ESC1 & Zerologon',
    desc:"2 scénarios ajoutés — modèle de certificat mal configuré permettant d'usurper n'importe quelle identité via PKINIT (ESC1), et faille cryptographique Netlogon permettant de réinitialiser sans identifiant le mot de passe du contrôleur de domaine (Zerologon, CVE-2020-1472) — total : 69 scénarios, famille « Active Directory / Windows » portée de 11 à 13." },
  { version:'v5.2', tag:'attaque', tagColor:'var(--purple)', done:true,
    title:'Pack « Applications web », 3ᵉ vague — CSRF & XXE',
    desc:"2 scénarios ajoutés — changement de mot de passe accepté sans jeton CSRF via un formulaire intersite auto-soumis, et entité externe XML non désactivée permettant de lire un fichier de secrets local (XXE) — total : 71 scénarios, famille « Applications web » portée de 11 à 13." },
  { version:'v5.3', tag:'grosse feature', tagColor:'#ff9e7c', done:true,
    title:'Nouvelle famille « Mobile & API embarquées »',
    desc:"3 scénarios ajoutés — clé API codée en dur dans un APK décompilé donnant accès à un endpoint d'administration, absence d'épinglage de certificat permettant l'interception du trafic, et redirect_uri OAuth non validé faisant fuiter un jeton d'accès — 7ᵉ famille technique du projet, total : 74 scénarios." },
  { version:'v5.4', tag:'système', tagColor:'var(--gold)', done:true,
    title:'Script de test formalisé (validate-scenarios.js)',
    desc:"Les vérifications refaites à la main à chaque ajout de scénario depuis la v5.1 deviennent un vrai script Node sans dépendance (`npm test`) : cohérence des ids, structure du système de fichiers simulé, invariant d'état initial, solveur best-effort à partir des indices — a d'ailleurs révélé et corrigé un piège classique des sandbox vm de Node dès sa première exécution." }
];
